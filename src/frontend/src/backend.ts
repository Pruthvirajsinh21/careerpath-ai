...
export class Backend implements backendInterface {
    ...
    async addMessage(arg0: Message): Promise<CareerGuidanceResponse> {
        if (this.processError) {
            try {
    ...
    async createUserProfile(arg0: string, arg1: UserRole, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createUserProfile(arg0, to_candid_UserRole_n3(this._uploadFile, this._downloadFile, arg1), arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getJobList(): Promise<Array<Job>> {
        if (this.processError) {
            try {
                const result = await this.actor.getJobList();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMatchingJobs(): Promise<Array<JobMatchResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMatchingJobs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async seedJobs(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedJobs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUserProfile(arg0: Array<string>, arg1: Array<string>, arg2: Array<string>, arg3: Array<string>): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        workStylePreferences: value.workStylePreferences,
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "employee" in value ? UserRole.employee : "student" in value ? UserRole.student : value;
}
